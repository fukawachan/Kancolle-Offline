...
const extraCacheDir = path.resolve(process.env.KANCOLLE_EXTRA_CACHE_DIR || "cache-extra");
...
const app = await buildApp({ cacheDir, extraCacheDir, stateStore, unknownLogPath, responseFormat });
...
console.log(`Extra cache: ${extraCacheDir}`);
